...
export function Reviews(){
    return (
        <MaxWidthWrapper className="relative max-w-5xl">
            ...
            aria-hidden="true" className="absolute select-none hidden xl:block -left-32 top-1/3"/>
            <ReviewGrid />
        </MaxWidthWrapper>
    )
}
...
function ReviewGrid(){
    ...
    return (
        <div 
        className="relative -mx-4 mt-16 grid h-[49rem] max-h-[150vh] grid-cols items-start gap-8 overflow-hidden px-4 sm:mt-20 md:grid-cols-2 lg:grid-cols-3" ref={containerRef}>
            {isInView ? (
                <>
